...
echo ""
echo -e "${CYAN}================================${NC}"
echo -e "${CYAN}다음 단계 (Next steps):${NC}"
echo -e "${CYAN}================================${NC}"
echo ""
echo "1. 작업 폴더로 이동:"
echo "   cd /path/to/your/workspace"
echo ""
echo "2. CLAUDE.md 템플릿 복사:"
echo "   cp $TEMP_DIR/templates/CLAUDE.md.template ./CLAUDE.md"
echo ""
echo "3. CLAUDE.md 열어서 본인 정보 입력 (이름, 학교, 진로 등)"
echo ""
echo "4. Claude Code 열고 첫 명령어 시도:"
echo "   /오늘"
echo ""
echo -e "${CYAN}================================${NC}"
echo ""
