...
> **"잘 하고 있는지 묻는 시간에 1개 더 만들어."**
>
> 한국 학생 개발자를 위한 Claude Code 슬래시 커맨드 모음
...
이 문장이 student-kit의 시작이야.

학생 개발자로서 매주 반복되는 작업 (자소서, 면접 준비, 공모전 탐색, 진로 고민) 을
일반 AI 도구로 처리하다가 깨달은 게 있음:

> **AI는 답을 주는 게 아니라, 진짜 질문을 끌어내야 한다.**

ChatGPT는 "자소서 써줘" 라고 하면 무난한 자소서를 줘. 근데 그 자소서는 면접관이 100개 중 99개와 똑같다고 느낌. 진짜 통과하는 자소서는 **너만의 unfair advantage** 가 박혀 있어야 함. 그건 AI가 모르고, **너 자신만 알아.**

근데 너 자신도 모를 때가 많음. 그래서 AI가 **진짜 질문을 던져서 끌어내야** 함.

이게 student-kit의 정체성이야. 자동화 도구가 아니라 **사고 강제 도구**.
...
5분 후, 너의 Claude Code는 너 전용으로 동작하고 있을 거야.

**그리고 너는 1개 더 만들고 있을 거야.** 잘 하고 있는지 묻는 시간 대신.

---

⭐ **이 repo가 도움됐다면 Star 눌러주세요!** 다른 학생들도 발견할 수 있게.
